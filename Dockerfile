...
CMD service nginx restart \
    ...
    && echo "INSERT INTO users (username, password, access) VALUES ('machine', crypt('$MACHINE_AUTH', gen_salt('bf', 10)), 'admin')" | psql postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_ENDPOINT}:${POSTGRES_PORT}/${POSTGRES_DB} || true \
