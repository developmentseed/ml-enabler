...
class MLModelVersionTestCase(BaseTestCase):
    def test_latest_version(self):
        ...
        version1 = MLModelVersionFactory(
            model_id=ml_model.id, version_major=1, version_minor=0, version_patch=0
        )
        version2 = MLModelVersionFactory(
            model_id=ml_model.id, version_major=2, version_minor=0, version_patch=0
        )
